  ...
  return (
    <main className="min-h-screen bg-background px-6 py-20">
      <div className="mx-auto max-w-2xl">
        ...
        <h1 className="mt-8 text-[32px] font-semibold tracking-tight text-foreground">About Resolvaio</h1>
        ...
        <div className="mt-10 space-y-8 text-[15px] leading-[1.7] text-muted-foreground">
          ...
          <h2 className="text-[20px] font-semibold text-foreground">What we do</h2>
          <p>
          ...
          <h2 className="text-[20px] font-semibold text-foreground">What we are not</h2>
          <p>
          ...
          <h2 className="text-[20px] font-semibold text-foreground">How it works</h2>
          ...
          <p>
            <strong className="text-foreground">Security deposits:</strong> California, Texas, New York, Florida
            (expanding based on demand).
          </p>
          <p>
            <strong className="text-foreground">Subscription cancellation:</strong> All US states (federal + state-specific
            where available).
          </p>
          ...
          <p>
            ...
            <a href="mailto:support@resolvaio.com" className="text-foreground underline underline-offset-4">
